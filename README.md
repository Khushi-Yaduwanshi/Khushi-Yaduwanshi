...
## 💫 About Me:
🔧 Currently working on **Full-Stack Web Apps** using **Tailwind CSS**, **Node.js**, and **MongoDB**  
🤝 Actively looking to **collaborate on UI/UX and frontend/backend integrations**  
🧠 Exploring advanced **React patterns**, clean **API structures**, and **backend scalability**  
💬 Ask me about: `HTML`, `CSS`, `JavaScript`, `Firebase`, `Express.js`, and `Tailwind CSS`  
⚡ **Fun Fact:** I love turning ideas into clean, animated UIs backed by solid architecture  
